...
int main(void){
  ...
  rt_task_create(&response_task_a, "response_task_a", 0, 99, T_CPU(0));
  rt_task_create(&response_task_b, "response_task_b", 0, 99, T_CPU(0));
  rt_task_create(&response_task_c, "response_task_c", 0, 99, T_CPU(0));
